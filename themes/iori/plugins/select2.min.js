/*! Select2 4.0.7 | https://github.com/select2/select2/blob/master/LICENSE.md */ ! function(e) {
    ...
    var t = function() {
            ...
            var n, r, i, o, s, a, l, c, u, d, p, h, f, g, m;
            ...
            function y(e, t) {
                var n, r, i, o, s, a, l, c, u, d, h, f = t && t.split("/"),
                    g = p.map,
                    v = g && g["*"] || {};
                if (e) {
            ...
            function b(e) {
                if (v(d, e)) {
                    var t = d[e];
                    delete d[e], h[e] = !0, s.apply(o, t)
                }
                if (!v(u, e) && !v(h, e)) throw new Error("No " + e);
                return u[e]
            }
            ...
            return t && t.requirejs || (t ? r = t : t = {}, u = {}, d = {}, p = {}, h = {}, f = Object.prototype.hasOwnProperty, g = [].slice, m = /\.js$/, l = function(e, t) {
                var n, r = A(e),
                    i = r[0],
                    o = t[1];
                return e = r[1], i && (n = b(i = y(i, o))), i ? e = n && n.normalize ? n.normalize(e, function(e) {
                    return function(t) {
                        return y(t, e)
                    }
                }(o)) : y(e, o) : (i = (r = A(e = y(e, o)))[0], e = r[1], i && (n = b(i))), {
                    f: i ? i + "!" + e : e,
                    n: e,
                    pr: i,
                    p: n
                ...
                var i, s, a, p, f, g, m, y = [],
                    $ = typeof n;
                if (g = x(r = r || e), "undefined" == $ || "function" == $) {
                    for (t = !t.length && n.length ? ["require", "exports", "module"] : t, f = 0; f < t.length; f += 1)
                        if ("require" === (s = (p = l(t[f], g)).f)) y[f] = c.require(e);
                        else if ("exports" === s) y[f] = c.exports(e), m = !0;
                    else if ("module" === s) i = y[f] = c.module(e);
                    else if (v(u, s) || v(d, s) || v(h, s)) y[f] = b(s);
                    else {
                        if (!p.p) throw new Error(e + " missing " + s);
                        p.p.load(p.n, _(r, !0), w(s), {}), y[f] = u[s]
                    }
                    a = n ? n.apply(u[e], y) : void 0, e && (i && i.exports !== o && i.exports !== u[e] ? u[e] = i.exports : a === o && m || (u[e] = a))
                } else e && (u[e] = n)
            }, n = r = a = function(e, t, n, r, i) {
                if ("string" == typeof e) return c[e] ? c[e](t) : b(l(e, x(t)).f);
                if (!e.splice) {
                    if ((p = e).deps && a(p.deps, p.callback), !t) return;
                    t.splice ? (e = t, t = n, n = null) : e = o
                }
                return t = t || function() {}, "function" == typeof n && (n = r, r = i), r ? s(o, e, t, n) : setTimeout((function() {
                    s(o, e, t, n)
                }), 4), a
            }, a.config = function(e) {
                return a(e)
                ...
                jQuery: !0
            }, t.requirejs = n, t.require = r, t.define = i), t.define("almond", (function() {})), t.define("jquery", [], (function() {
                var t = e || $;
                    ...
                    this.data.current((function(r) {
                        ...
                        n.$results.find(".select2-results__option[aria-selected]").each((function() {
                            var n = e(this),
                                ...
                                o = "" + r.id;
                            null != r.element && r.element.selected || null == r.element && -1 < e.inArray(o, i) ? n.attr("aria-selected", "true") : n.attr("aria-selected", "false")
                        }))
                    }))
                ...
                return r.prototype.bind = function(e, t, n) {
                    ...
                    if (t.call(this, r), !(0 < this.$selection.find(".select2-selection__placeholder").length || 0 === r.length)) {
                ...
                return e.prototype.query = function(e, t, n) {
                    ...
                    this.current((function(i) {
                        ...
                        0 < r.maximumSelectionLength && o >= r.maximumSelectionLength ? r.trigger("results:message", {
                ...
                return t.prototype.append = function(e, t) {
                    ...
                    t.call(this, n, r), n.on("query", (function(e) {
                        ...
                        if (!i.loading && t) {
                            ...
                            i.$loadingMore.offset().top + i.$loadingMore.outerHeight(!1) <= n + 50 && i.loadMore()
                        }
                    }))
                ...
                return n.prototype.bind = function(e, t, n) {
                    ...
                    var n = e("<span></span>"),
                        r = t.call(this);
                    return n.append(r), this.$dropdownContainer = n
            ...
            })), t.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], (function(e, t, n, r, i, o, s, a, l, c, u, d, p, h, f, g, m, v, y, _, $, w, b, A, x, D, S, E, C) {
                function O() {
                    this.reset()
                }
                return O.prototype.apply = function(d) {
                    if (null == (d = e.extend(!0, {}, this.defaults, d)).dataAdapter) {
                        if (null != d.ajax ? d.dataAdapter = f : null != d.data ? d.dataAdapter = h : d.dataAdapter = p, 0 < d.minimumInputLength && (d.dataAdapter = c.Decorate(d.dataAdapter, v)), 0 < d.maximumInputLength && (d.dataAdapter = c.Decorate(d.dataAdapter, y)), 0 < d.maximumSelectionLength && (d.dataAdapter = c.Decorate(d.dataAdapter, _)), d.tags && (d.dataAdapter = c.Decorate(d.dataAdapter, g)), null == d.tokenSeparators && null == d.tokenizer || (d.dataAdapter = c.Decorate(d.dataAdapter, m)), null != d.query) {
                    ...
                    if (null == d.resultsAdapter && (d.resultsAdapter = n, null != d.ajax && (d.resultsAdapter = c.Decorate(d.resultsAdapter, A)), null != d.placeholder && (d.resultsAdapter = c.Decorate(d.resultsAdapter, b)), d.selectOnClose && (d.resultsAdapter = c.Decorate(d.resultsAdapter, S))), null == d.dropdownAdapter) {
                        if (d.multiple) d.dropdownAdapter = $;
                        else {
                            var T = c.Decorate($, w);
                            d.dropdownAdapter = T
                        }
                        if (0 !== d.minimumResultsForSearch && (d.dropdownAdapter = c.Decorate(d.dropdownAdapter, D)), d.closeOnSelect && (d.dropdownAdapter = c.Decorate(d.dropdownAdapter, E)), null != d.dropdownCssClass || null != d.dropdownCss || null != d.adaptDropdownCssClass) {
                    ...
                    if (e.isArray(d.language)) {
                        var I = new u;
                        d.language.push("en");
                        for (var P = d.language, k = 0; k < P.length; k++) {
                            var R = P[k],
                                U = {};
                            try {
                                U = u.loadPath(R)
                    ...
                    this.defaults = {
                        ...
                        matcher: function n(r, i) {
                            ...
                            if (i.children && 0 < i.children.length) {
                                for (var o = e.extend(!0, {}, i), s = i.children.length - 1; 0 <= s; s--) null == n(r, i.children[s]) && o.children.splice(s, 1);
                ...
                return i.prototype.fromElement = function(e) {
                    ...
                    for (var p in d = r._convertData(d)) - 1 < t.inArray(p, n) || (t.isPlainObject(this.options[p]) ? t.extend(this.options[p], d[p]) : this.options[p] = d[p]);
                    return this
