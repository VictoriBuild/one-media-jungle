...
! function(t) {
            ...
            t.position = {
                ...
                return m = function(e) {
                    ...
                    var a, r, h = t(this),
                        ...
                        m = i(this, "marginLeft"),
                        k = i(this, "marginTop"),
                        x = l + m + i(this, "marginRight") + b.width,
                        C = u + k + i(this, "marginBottom") + b.height,
                        D = t.extend({}, g),
    ...
    t.effects.define("blind", "hide", (function(e, i) {
        ...
        for (t.effects.createPlaceholder(a), o = a.css(m), u || (u = a["top" === m ? "outerHeight" : "outerWidth"]() / 3), l && ((n = {
                opacity: 1
            })[m] = o, a.css("opacity", 0).css(m, _ ? 2 * -u : 2 * u).animate(n, f, g)), h && (u /= Math.pow(2, d - 1)), (n = {})[m] = o; d > v; v++)(s = {})[m] = (_ ? "-=" : "+=") + u, a.animate(s, f, g).animate(n, f, g), u = h ? 2 * u : u / 2;
        h && ((s = {
            opacity: 0
        ...
        function s() {
            _.push(this), _.length === c * u && (d.css({
                visibility: "visible"
            }), t(_).remove(), i())
        }
        var n, o, a, r, h, l, c = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3,
            ...
            _ = [];
        for (n = 0; c > n; n++)
            for (r = f.top + n * m, l = n - (c - 1) / 2, o = 0; u > o; o++) a = f.left + o * g, h = o - (u - 1) / 2, d.clone().appendTo("body").wrap("<div></div>").css({
                position: "absolute",
                visibility: "visible",
                left: -o * g,
                top: -n * m
        ...
        var s = t(this),
            ...
            c = 1,
            u = s.queue().length;
        for ((o || !s.is(":visible")) && (s.css("opacity", 0).show(), l = 1); r > c; c++) s.animate({
            opacity: l
        }, h, e.easing), l = 1 - l;
        s.animate({
            opacity: l
    ...
    t.ui.ddmanager = {
        ...
        _refreshItems: function(e) {
            ...
            for (i = u.length - 1; i >= 0; i--)
                for (a = u[i][1], s = 0, l = (r = u[i][0]).length; l > s; s++)(h = t(r[s])).data(this.widgetName + "-item", a), c.push({
                    item: h,
                    instance: a,
                    width: 0,
                    height: 0,
