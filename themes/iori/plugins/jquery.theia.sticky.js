    ...
    i.fn.theiaStickySidebar = function(t) {
        function e(t, e) {
            return !0 === t.initialized || !(i("body").width() < t.minWidth) && (function(t, e) {
                t.initialized = !0;
                var a = i("#theia-sticky-sidebar-stylesheet-" + t.namespace);
                0 === a.length && i("head").append(i('<style id="theia-sticky-sidebar-stylesheet-' + t.namespace + '">.theiaStickySidebar:after {content: ""; display: table; clear: both;}</style>'));
                e.each((function() {
                    var e = {};
                        ...
                        if (e.stickySidebar.is(":visible"))
                            if (i("body").width() < e.options.minWidth) d();
                                ...
                                if (e.options.disableOnResponsiveLayouts)
                                    if (e.sidebar.outerWidth("none" == e.sidebar.css("float")) + 50 > e.container.width()) return void d();
                                var a = i(document).scrollTop(),
                                    n = "static";
                                if (a >= e.sidebar.offset().top + (e.paddingTop - e.options.additionalMarginTop)) {
                                    var s, c = e.paddingTop + t.additionalMarginTop,
                                        p = e.paddingBottom + e.marginBottom + t.additionalMarginBottom,
                                        b = e.sidebar.offset().top,
                                        l = e.sidebar.offset().top + r(e.container),
                                        f = 0 + t.additionalMarginTop;
                                    s = e.stickySidebar.outerHeight() + c + p < i(window).height() ? f + e.stickySidebar.outerHeight() : i(window).height() - e.marginBottom - e.paddingBottom - t.additionalMarginBottom;
                                    var h = b - a + e.paddingTop,
                                        g = l - a - e.paddingBottom - e.marginBottom,
                                        u = e.stickySidebar.offset().top - a,
                                        S = e.previousScrollTop - a;
                                    "fixed" == e.stickySidebar.css("position") && "modern" == e.options.sidebarBehavior && (u += S), "stick-to-top" == e.options.sidebarBehavior && (u = t.additionalMarginTop), "stick-to-bottom" == e.options.sidebarBehavior && (u = s - e.stickySidebar.outerHeight()), u = S > 0 ? Math.min(u, f) : Math.max(u, s - e.stickySidebar.outerHeight()), u = Math.max(u, h), u = Math.min(u, g - e.stickySidebar.outerHeight());
                                    var m = e.container.height() == e.stickySidebar.outerHeight();
                                    n = (m || u != f) && (m || u != s - e.stickySidebar.outerHeight()) ? a + u - e.sidebar.offset().top - e.paddingTop <= t.additionalMarginTop ? "static" : "absolute" : "fixed"
                                }
                                if ("fixed" == n) {
                                    ...
                                    var k = {};
                                    "absolute" != e.stickySidebar.css("position") && (k.position = "absolute", k.transform = "translateY(" + (a + u - e.sidebar.offset().top - e.stickySidebarPaddingTop - e.stickySidebarPaddingBottom) + "px)", k.top = "0px"), k.width = o(e.stickySidebar) + "px", k.left = "", e.stickySidebar.css(k)
                                } else "static" == n && d();
                                "static" != n && 1 == e.options.updateSidebarHeight && e.sidebar.css({
                                    "min-height": e.stickySidebar.outerHeight() + e.stickySidebar.offset().top - e.sidebar.offset().top + e.paddingBottom
                                }), e.previousScrollTop = a
                            }
        ...
        return (t = i.extend({
            ...
            function(t, o) {
                var a = e(t, o);
                a || (console.log("TSS: Body width smaller than options.minWidth. Init is delayed."), i(document).on("scroll." + t.namespace, function(t, o) {
                    return function(a) {
