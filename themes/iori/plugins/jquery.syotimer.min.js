! function(e, t) {
    ...
    var t = "day",
        ...
        u = {
            init: function(t) {
                var i = e.extend({}, s, t || {});
                i.itemTypes = l.getItemTypesByLayout(i.layout), i._itemsHas = e.extend({}, d);
            ...
            _render: function() {
                for (var t = e(this), i = t.data("syotimer-options"), n = l.getTimerItem(), o = e("<div/>", {
                    ...
                    var u = n.clone();
                    u.addClass("syotimer-cell_type_" + i.itemTypes[d]), r.append(u), s[i.itemTypes[d]] = u
                }
                var m = {
                    headBlock: o,
                    bodyBlock: r,
                ...
                t.data("syotimer-blocks", m).data("syotimer-items", s).addClass("syotimer").append(o).append(r).append(a)
            },
            _perSecondHandler: function() {
                ...
                var n = new Date,
                    ...
                    r = l.getDifferenceWithTimezone(n, o, i),
                    a = l.getSecondsToDeadLine(r, i);
                0 <= a ? (u._refreshUnitsDom.apply(this, [a]), u._applyEffectSwitch.apply(this, [i.effectType])) : (t = e.extend(t, t.data("syotimer-blocks")), i.afterDeadline(t))
            },
            _refreshUnitsDom: function(i) {
                var n = e(this),
                    ...
                    a = o.itemTypes,
                    s = l.getUnitsToDeadLine(i);
                o._itemsHas.day || (s.hour += 24 * s.day), o._itemsHas.hour || (s.minute += 60 * s.hour), o._itemsHas.minute || (s.second += 60 * s.minute);
                for (var d = 0; d < a.length; d++) {
                    var u = a[d],
                        m = s[u],
                        c = r[u];
                    c.data("syotimer-unit-value", m), e(".syotimer-cell__value", c).html(l.format2(m, u !== t && o.doubleNumbers)), e(".syotimer-cell__unit", c).html(e.syotimerLang.getNumeral(m, o.lang, u))
                }
            },
            _applyEffectSwitch: function(t, i) {
                ...
                "none" === t ? setTimeout((function() {
                    u._perSecondHandler.apply(d, [])
                }), 1e3) : "opacity" !== t || (n = l.data("syotimer-items")[i]) && (r = a.next(i), s = n.data("syotimer-unit-value"), e(".syotimer-cell__value", n).animate({
                    opacity: .1
                }, 1e3, "linear", (function() {
                    u._perSecondHandler.apply(d, [])
                })), r && 0 === s && u._applyEffectSwitch.apply(d, [t, r]))
            }
        },
        l = {
            ...
            getSecondsToDeadLine: function(e, t) {
                var i, n, o, r, a = e / 1e3;
                a = Math.floor(a);
                return t.periodic ? (r = e / (1e3 * (o = l.getPeriodUnit(t.periodUnit))), r = Math.ceil(r), r = Math.abs(r), 0 <= a ? (n = 0 == (n = r % t.periodInterval) ? t.periodInterval : n, --n) : n = t.periodInterval - r % t.periodInterval, 0 == (i = a % o) && a < 0 && n--, Math.abs(n * o + i)) : a
            },
            getUnitsToDeadLine: function(e) {
                var i = t,
                    n = {};
                do {
                    var o = l.getPeriodUnit(i);
            ...
            getDifferenceWithTimezone: function(e, t, o) {
                var r = t.getTime() - e.getTime(),
                    a = 0,
                    s = 0;
                return "local" !== o.timeZone && (a = 1e3 * (parseFloat(o.timeZone) * l.getPeriodUnit(i) - -e.getTimezoneOffset() * l.getPeriodUnit(n))), o.ignoreTransferTime && (s = 1e3 * (-e.getTimezoneOffset() * l.getPeriodUnit(n) - -t.getTimezoneOffset() * l.getPeriodUnit(n))), r - (a + s)
            },
