...
function(t, e) {
    ...
    function o(o) {
        if (i(), "string" == typeof o && (o = document.querySelector(o)), o && "object" == typeof o && o.nodeType) {
            ...
            for (var h = u.isBorderBox = "border-box" == s.boxSizing, d = 0; d < a; d++) {
                var l = r[d],
                    f = s[l],
                    m = parseFloat(f);
                u[l] = isNaN(m) ? 0 : m
            ...
            var S = t(s.height);
            return !1 !== S && (u.height = S + (I ? 0 : p + _)), u.innerWidth = u.width - (c + v), u.innerHeight = u.height - (p + _), u.outerWidth = u.width + y, u.outerHeight = u.height + g, u
        }
    }
